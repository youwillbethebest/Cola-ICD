...
def main_worker(rank, args):
    ...
    label_loader = SynonymLabelLoader(codes_file=args.codes_file, synonyms_file=args.synonyms_file, abbreviations_file=args.abbreviations_file, pretrained_model_name=args.label_model_name, max_length=args.label_max_length,term_count=args.term_count,sort_method='max')
